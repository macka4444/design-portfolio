...
const chanceandchoice = {
  ...
  description: (
    <div>
      ...
      <p className="body-text">
        The virtual experience was made on the Mozilla hubs platform. It was an
        interesting opportunity to think about interactivity and user experience
        which I hope to explore more in my work in the future.
      </p>
    </div>
  ),
};
